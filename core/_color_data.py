...
TABLEAU_COLORS_NORM = {'tab:' + name: value
...
XKCD_COLORS_NORM = {'xkcd:' + name: value
                    for name, value in XKCD_COLORS.items()}
...
# Normalize name to "tab:<name>" to avoid name collisions.
CSS4_COLORS_NORM = {'css:' + name: value
                    for name, value in CSS4_COLORS.items()}
